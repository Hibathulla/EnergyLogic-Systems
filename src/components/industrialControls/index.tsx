...
const IndustrialControls = () => {
  return (
    <SectionLayout className="h-171 grid justify-center items-end bg-[linear-gradient(to_bottom,rgba(0,0,0,0),rgba(0,0,0,0.5)),url('/assets/images/industrial-controls/industrial-controls-bg.png')] bg-cover bg-no-repeat bg-center">
