...
const GeControls = () => {
  ...
  return (
    <SectionLayout className="grid justify-center bg-[linear-gradient(to_bottom,rgba(0,0,0,0),rgba(0,0,0,0.5)),url('/assets/images/ge-controls/ge-controls-bg.png')] bg-cover bg-no-repeat bg-center">
