...
const OnlineStore = () => {
  return (
    <section className="h-171 bg-[linear-gradient(to_bottom,rgba(0,0,0,0),rgba(0,0,0,0.5)),url('/assets/images/online-store/online-store-bg.png')] bg-cover bg-no-repeat bg-center">
